...
ERP_values_df %>% ggplot(aes(value)) +
    ...
    labs(title = "Implied ERP (n = 10,000 sims) under tight assumption dispersion (CV = σ/μ = 10%)",
         subtitle = "Green vertical line is the mean",
         y = "Count") +
    # xlab("X label") + 
    # ylab("Count") +
    theme_classic() +
...
df %>% ggplot(aes(x = G2, y = ERP)) + 
  ...
  labs(title = "Restores 10% COV randomness to earnings and payout vectors") +
